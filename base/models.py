...
class Anfitrião(models.Model):
    ...
    n_filhos = models.CharField('Se possuir filhos, informar o Nº', max_length=17, blank=True, null=True)
    ...
    tipo_doenca = models.CharField('Se tiver alguém doente, informar o tipo de doença', max_length=17, blank=True, null=True)
    tipo_deficiencia = models.CharField('Se tiver alguém deficiente, informar o tipo da deficiência', max_length=17, blank=True, null=True)    
